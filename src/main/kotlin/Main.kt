...
fun main() {
    ...
    val me = Person("Ethan", "Fischer")
    val you = Person("Stephen", "Ellsworth", "Paul")
    ...
    //When in kotlin replaces switch from java
    ...
    when(burgersOrdered){
        /*compares abs value of burgersOrdered to burgersOrdered, if they're the same it was a
         0 or positive, if they don't match then burgers ordered was negative
         */
    ...
    /*
    in operation checks if object is within the defined range,
